...
public class addToCartTest extends BaseIT {
	...
	public void sucessDiffCarts() throws InvalidCartId_Exception, InvalidItemId_Exception, InvalidQuantity_Exception, NotEnoughItems_Exception {		
		...
		Assert.assertEquals(_suppliers.get(0).getWsURL(), carts.get(0).getItems().get(0).getItem().getItemId().getSupplierId());
		...
		Assert.assertEquals(_suppliers.get(1).getWsURL(), carts.get(1).getItems().get(0).getItem().getItemId().getSupplierId());
		...
		Assert.assertEquals(_suppliers.get(2).getWsURL(), carts.get(2).getItems().get(0).getItem().getItemId().getSupplierId());
	}
	...
	public void sucessSameCart() throws InvalidCartId_Exception, InvalidItemId_Exception, InvalidQuantity_Exception, NotEnoughItems_Exception {		
		...
		Assert.assertEquals(_suppliers.get(1).getWsURL(), carts.get(0).getItems().get(1).getItem().getItemId().getSupplierId());
		...
		Assert.assertEquals(_suppliers.get(2).getWsURL(), carts.get(0).getItems().get(2).getItem().getItemId().getSupplierId());
	}
	...
	public void nullItemId() throws InvalidCartId_Exception, InvalidItemId_Exception, InvalidQuantity_Exception, NotEnoughItems_Exception{
		...
		itemId.setSupplierId(_suppliers.get(0).getWsURL());
