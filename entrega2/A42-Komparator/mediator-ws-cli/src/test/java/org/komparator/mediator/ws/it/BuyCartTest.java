...
public class BuyCartTest extends BaseIT {
	...
	public void setUp() throws BadProductId_Exception, BadProduct_Exception, InvalidCartId_Exception, InvalidItemId_Exception, InvalidQuantity_Exception, NotEnoughItems_Exception{
		...
		itemId1.setSupplierId(_suppliers.get(0).getWsURL());
		...
		itemId2.setSupplierId(_suppliers.get(1).getWsURL());
		...
		itemId3.setSupplierId(_suppliers.get(2).getWsURL());
	}
	...
	public void invalidCC() throws EmptyCart_Exception, InvalidCartId_Exception, InvalidCreditCard_Exception{
		mediatorClient.buyCart("Cart1", "1111");
	}
	@Test(expected =  InvalidCreditCard_Exception.class)
	public void spaceCCnum() throws EmptyCart_Exception, InvalidCartId_Exception, InvalidCreditCard_Exception{
		mediatorClient.buyCart("Cart1", " ");
	}
	@Test(expected =  InvalidCreditCard_Exception.class)
	public void nlCnum() throws EmptyCart_Exception, InvalidCartId_Exception, InvalidCreditCard_Exception{
		mediatorClient.buyCart("Cart1", "\n");
	}
	@Test(expected =  InvalidCreditCard_Exception.class)
	public void tabCnum() throws EmptyCart_Exception, InvalidCartId_Exception, InvalidCreditCard_Exception{
		mediatorClient.buyCart("Cart1", "\t");
	}
	@Test(expected =  InvalidCreditCard_Exception.class)
	public void nullCnum() throws EmptyCart_Exception, InvalidCartId_Exception, InvalidCreditCard_Exception{
		mediatorClient.buyCart("Cart1", null);
	}
	@Test(expected =  InvalidCreditCard_Exception.class)
	public void emptyCCnum() throws EmptyCart_Exception, InvalidCartId_Exception, InvalidCreditCard_Exception{
		mediatorClient.buyCart("Cart1", "");
	}
